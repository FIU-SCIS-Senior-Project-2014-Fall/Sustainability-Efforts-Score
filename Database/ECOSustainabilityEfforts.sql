...
INSERT INTO `contest_boundary` VALUES (1,'Date Range'),(2,'Location');
/*!40000 ALTER TABLE `contest_boundary` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `contest_ends`
--

DROP TABLE IF EXISTS `contest_ends`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `contest_ends` (
...
--
-- Dumping data for table `contest_ends`
--

LOCK TABLES `contest_ends` WRITE;
/*!40000 ALTER TABLE `contest_ends` DISABLE KEYS */;
INSERT INTO `contest_ends` VALUES (1,'First User'),(2,'Contest Expires');
/*!40000 ALTER TABLE `contest_ends` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `contest_info` WRITE;
/*!40000 ALTER TABLE `contest_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `contest_info` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `contest_to_admin`
--

DROP TABLE IF EXISTS `contest_to_admin`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `contest_to_admin` (
  `contestToAdminID` int(11) NOT NULL,
  `contestID` int(11) DEFAULT NULL,
  `adminID` int(11) DEFAULT NULL,
  PRIMARY KEY (`contestToAdminID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `contest_to_admin`
--

LOCK TABLES `contest_to_admin` WRITE;
/*!40000 ALTER TABLE `contest_to_admin` DISABLE KEYS */;
/*!40000 ALTER TABLE `contest_to_admin` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `contest_to_group`
--

LOCK TABLES `contest_to_group` WRITE;
/*!40000 ALTER TABLE `contest_to_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `contest_to_group` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `contest_type` (
  `contestTypeID` int(11) NOT NULL AUTO_INCREMENT,
  `contestTypeName` varchar(45) DEFAULT NULL,
...
INSERT INTO `contest_type` VALUES (1,'Items'),(2,'Points');
...
--
-- Dumping data for table `group_configuration`
--

LOCK TABLES `group_configuration` WRITE;
/*!40000 ALTER TABLE `group_configuration` DISABLE KEYS */;
/*!40000 ALTER TABLE `group_configuration` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `item_to_material_makeup`
--

LOCK TABLES `item_to_material_makeup` WRITE;
/*!40000 ALTER TABLE `item_to_material_makeup` DISABLE KEYS */;
/*!40000 ALTER TABLE `item_to_material_makeup` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `recycling_action`
--

LOCK TABLES `recycling_action` WRITE;
/*!40000 ALTER TABLE `recycling_action` DISABLE KEYS */;
/*!40000 ALTER TABLE `recycling_action` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `user` VALUES (1,'georgem','mcgarry','georgem','country','mcgarryg@hotmail.com','48af04c5-6e11-11e4-a032-e82aea66e701',1);
...
INSERT INTO `user_group_request` VALUES (2,1,2,2,'2014-11-12 11:02:35','\0','');
...
BEGIN
	INSERT INTO contest
		(contestName, contestPrize, contestType, threshold, contestEnds, materialType, boundaryType, dateStart, dateEnd, createdByUserID)
	VALUES (in_name, in_prize, in_type, in_threshold, in_ends, in_material, in_boundary, in_from, in_to, in_userID);
...
BEGIN
    ...
    IF (userExists > 0) THEN
        ...
        INSERT INTO `ecosustainabilityefforts`.`group` (groupName, userID, email, address1, address2, city, stateID, countryID, zipcode)
            VALUES (in_groupName, in_userid , in_email, in_address1, in_address2, in_city, in_state, in_country, in_zipcode);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `getContestType` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `getContestType`()
BEGIN
    SELECT 
		contestTypeID,
		contestTypeName
...
BEGIN
    SELECT count(*) as total FROM `recycling_action`;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `accept_user_users_view` AS select `user`.`userID` AS `userID`,`user`.`firstName` AS `firstName`,`user`.`lastName` AS `lastName`,`user`.`email` AS `email`,`user_group_request`.`groupID` AS `groupID`,`user_group_request`.`status` AS `status` from (`user` join `user_group_request` on((`user`.`userID` = `user_group_request`.`userID`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2014-11-17 10:55:41
